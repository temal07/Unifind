    ...
    <div className='flex flex-col gap-5 ml-52'>
      ...
      <div className='flex flex-col gap-10 w-full max-w-lg'>
        ...
        <div className='flex-1'>
          ...
          <div className="flex gap-4 border-t-2 mb-20 mt-5">
